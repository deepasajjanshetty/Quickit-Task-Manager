        ...
        <div class="flex justify-between items-start">
          <div >
            <nav class="flex items-center space-x-2 text-sm text-blue-100 mb-1">
              ...
              <span>/</span>
              <span class="text-white">IT Projects</span>
            </nav>
          ...
          <div class="text-right">
            <div class="text-white text-sm mt-10">
              <span>Customer: Sarah Wilson</span>
          ...
          <div class="flex gap-6">
            ...
            <div>
              ...
              <div class="flex gap-1 flex-wrap">
                ...
                <button 
                  @click="selectTag('blue')" 
                  :class="[
                    'text-xs px-2 py-1 rounded-sm transition-colors cursor-pointer',
                    selectedTag === 'blue' 
                      ? 'bg-blue-500 text-white' 
                      : 'bg-blue-500/50 text-blue-300 hover:bg-blue-500/70'
                  ]"
                >
                  Infrastructure
                </button>
                <button 
                  @click="selectTag('green')" 
                  :class="[
                    'text-xs px-2 py-1 rounded-sm transition-colors cursor-pointer',
                    selectedTag === 'green' 
                      ? 'bg-green-500 text-white' 
                      : 'bg-green-500/50 text-green-300 hover:bg-green-500/70'
                  ]"
                >
                  Security
                </button>
          ...
          <div>
            <div class="flex items-center gap-3">
              ...
              <div class="w-6 h-6  border-2 border-gray-300 rounded-full flex items-center justify-center">
                <span class="text-gray-700 text-white text-xs font-medium">3</span>
              </div>
              ...
              <div class="flex -space-x-2">
                <div class="w-8 h-8 bg-blue-400 rounded-full border-2 border-gray-800 flex items-center justify-center">
                  <span class="text-white text-xs font-medium">SW</span>
                </div>
...
const currentProjectTitle = ref('IT Projects')
...
// Task data with priority information and date ranges for IT Projects
const allTasks = ref({
  backlog: [
    {
      id: 1,
    ...
    {
      id: 4,
      title: 'Backup system evaluation',
      priority: 'High',
      date: 'Mar 01, 2025',
      dateColor: 'blue', // Infrastructure
      members: ['SW', 'MJ'],
    ...
    {
      id: 6,
      title: 'Hardware upgrade planning',
      priority: 'Low',
      date: 'Mar 31, 2025',
      dateColor: 'blue', // Infrastructure
      members: ['SW'],
    ...
    {
      id: 7,
      title: 'Cybersecurity training setup',
      priority: 'High',
      date: 'Apr 15, 2025',
      dateColor: 'green', // Security
      members: ['RK', 'MJ'],
...
const getTaskCardClass = (dateColor) => {
  switch (dateColor) {
    case 'blue': // Infrastructure
      return 'bg-blue-500/20 border border-blue-500/30 rounded-xl p-4 cursor-pointer hover:bg-blue-500/30 transition-all'
    case 'green': // Security
      return 'bg-green-500/20 border border-green-500/30 rounded-xl p-4 cursor-pointer hover:bg-green-500/30 transition-all'
    case 'purple': // Network
